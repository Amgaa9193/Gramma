...
var correctTextAnswer = ['Gramma thinks you are correct', 'Gramma congratulate you on your proper use of English'];
...
if (chromeAgent) {
  ...
  var currentdiv = document.getElementsByClassName('.logo'); // currentNav.insertBefore(image, currentdiv);

  currentNav.prepend(image);

  function grammaSays() {
    // const lang = speechSynthesisUtteranceInstance.lang = 'en-US';
    var speechText = correctTextAnswer[Math.floor(Math.random() * correctTextAnswer.length)];
